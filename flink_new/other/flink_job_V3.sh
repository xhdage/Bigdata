...
# 检测日志记录位置 
checkFlinkLogPath=/home/datalake/liyuan/flink/temp/checkFlink.log
...
#临时存放chk-xxxx文件路径
lastCheckpointFile=/home/datalake/liyuan/flink/temp/lastCheckpointFile
tmpCheckpointFile=/home/datalake/liyuan/flink/temp/tmpCheckpointFile
#每次执行前清空
...
do
	...
	echo "false, can not find last checkpoint" >> $checkFlinkLogPath
	exit
    else 
	...
	#   exit
        ...
        #export  HADOOP_USER_NAME=hdfs
        bash /home/datalake/liyuan/flink/startFlink.sh $lastCkMeta
        echo "执行完成" >> $checkFlinkLogPath
        echo "\n"
        break
    fi
done 
