...
dateFilePath2=rawrm_2022
dateFilePath3=rawrm_2022_03

feedPath=feed3_2022_03

dateFilePath=$dateFilePath1/$dateFilePath2/$dateFilePath3/${feedPath}.txt
#temp目录，临时目录
tempFile1=$dateFilePath1/$dateFilePath2/$dateFilePath3/temp3.txt
tempFile2=$dateFilePath1/$dateFilePath2/$dateFilePath3/temp3_1.txt
#删除日志
...
#截取/raw到具体年份
cut -d '/' -f 2,3,4,5,6,7 $tempFile1 >> $tempFile2
#行首添加字符串“/”
sed -i 's/^/\//g' $tempFile2
